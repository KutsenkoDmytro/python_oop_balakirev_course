...
P.S. В программе нужно объявить только класс. На экран ничего выводить не нужно.Memory limit: 256 MBTime limit: 15 seconds

'''

class ConnectionError(Exception):
    '''Класс исключений при подключении.'''
