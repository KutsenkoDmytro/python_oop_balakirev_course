...
play(self) - для воспроизведения видео (метод выводит на экран строку "воспроизведение видео ").
...
Создайте два объекта v1 и v2 класса Video, затем, через метод create() передайте им имена
"Python" и "Python ООП". После этого с помощью метода add_video класса YouTube,
...
class YouTube:
    '''Загрузка и воспроизведение видео на сайте.'''
    videos = list()
    ...
    def play(cls, video_indx):
        current_video = cls.videos[video_indx]
        current_video.play()
