...
kyrylitsa = "абвгдеёжзийклмнопрстуфхцчшщъыьэюя"
letters = ascii_letters + kyrylitsa + kyrylitsa.upper()+' '

text_lst = ''.join([ch for ch in text if ch in letters]).split()
res = sum([1 for wrd in text_lst
        for obj in dict_words if wrd == obj])
