...
#ДЕТОРАТОР МЕТОДОВ КЛАССА


class Dec:
    '''Декоратор который декорирует все вызываемые методы класса.
        и проверяет переданые им аргументы на целочисленный тип.
    '''
