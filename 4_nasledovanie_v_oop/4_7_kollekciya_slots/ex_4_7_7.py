...
Объявите класс с именем Notes, в объектах которого разрешены только локальные атрибуты с именами (ограничение задается через коллекцию slots):
...
class Note:
    ...
    def __setattr__(self, key, value):
        if key == '_name' and value not in ['до', 'ре', 'ми', 'фа', 'соль',
                                            'ля', 'си']:
            raise ValueError('недопустимое значение аргумента')
...
class Notes:
    ...
    def __init__(self):
        notes_dict = {'_do': 'до', '_re': 'ре', '_mi': 'ми', '_fa': 'фа',
                      '_solt': 'соль', '_la': 'ля', '_si': 'си'}
