...
Так как базовый класс Validator - это общий класс для всех видов проверок, то метод _is_valid() будет просто возвращать True. Кроме того, объекты класса Validator:
...
IntegerValidator - для проверки, что data - целое число в заданном диапазоне; FloatValidator - для проверки, что data - вещественное число в заданном диапазоне.
...
class Validator:
    '''Базовый функционал для проверки корректности данных.'''
...
class IntegerValidator(Validator):
    '''Проверяет целые числа на вхождение в диапазон.'''
...
class FloatValidator(Validator):
    '''Проверяет вещественные числа на вхождение в диапазон.'''
    def __init__(self, min_value, max_value):
        self.min_value = min_value
        self.max_value = max_value
